...
----
<1> We are not even using the the variable `line` in the code.

This might be getting a little old, but this is probably better provided as a reusable function.
