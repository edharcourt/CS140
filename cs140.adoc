...
Here is a small image of a rainbow toad footnote:[accessed on 7/23/2017 http://www.bbc.co.uk/nature/14151541] that we will enlarge.
...
Now all that is left is to call `neighborhood_mean` for every pixel in the image, and write the new image to an initially empty surface.
