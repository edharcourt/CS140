...
TIP: JPEG (_Joint Photographic Experts Group_ footnote:[https://jpeg.org/]) uses some advanced mathematics to achieve good, but lossy, compression.  

Sometimes lossy compression is not acceptable. For example, 
