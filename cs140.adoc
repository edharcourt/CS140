...
If a hacker was tryig to break into a system by trying all possible passwords how long might it take? Lets say we had a powerful computer that could try 1 million passwords per second that would be stem:[5.4 \times 10^{19}/10^6 = 5.4 \times 10^{13}] seconds, or stem:[10^{13}/60 = 1.67 \times 10^{11}] minutes, which is stem:[1.67 \times 10^{11} / 60 = 2.78 \times 10^9] hours, which is stem:[2.78 \times 10^9/24 = 1.16 \times 10^{8}] days, or 316 thousand years ... approximately.
