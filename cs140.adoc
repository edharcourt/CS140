...
The follwoing program for hiding a message in an image puts it all together.
...
# Main Program
image = pygame.image.load("../images/png/some_image.png")  <1>
...
----
<1> Make sure the image is a PNG image. Why? Because of lossless compression.
...
<9> This is a new pygame command that saves a surface in a new file.
