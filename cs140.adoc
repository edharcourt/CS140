...
print(chips) <2>
----
<1> Just remove the condition that we stop when we hit 2000.
<2> What will always get printed?

We don't even need to run the program to see what will happen here. This is the _Gambler's Ruin_. A gambler who gamles long enough will always lose everything!
