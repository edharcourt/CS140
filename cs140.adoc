...
duplicate lots of code. The variables `head_x`, `head_y`, `head_w`, `head_h` are parameters and they can be used anywhere in the function body. That is their _scope_.
...
We need to examine they way in which `draw_blockhead` uses variables. 
...
. Which line contains the function header?
