...
This document is written in http://asciidoctor.org/[asciidoctor]. Thank you to Dan Allen for creating such a wonderful tool. It also uses the https://tscanlin.github.io/tocbot/[Tocbot] https://github.com/asciidoctor/asciidoctor/issues/699#issuecomment-321429137[table of contents plugin] described in this thread footnote:[https://github.com/asciidoctor/asciidoctor/issues/699#issuecomment-321429137] and Dan Allen's
https://github.com/asciidoctor/asciidoctor-extensions-lab/blob/master/lib/view-result-docinfoprocessor.rb[view-result plugin]. Any mathematics is formatted using https://www.mathjax.org/[MathJax].footnote:[https://www.mathjax.org/]. The Python syntax highlighter is http://pygments.org/[pygments].footnote:[http://pygments.org/]
...
How can we fix this? We will do it in one of two ways. We can slice off the last character in the line (the newline character) before we print it.
...
Or we can tell the print function not to print a newline character using a _named parameter_.
...
for line in f:
    print(line, end='') <1>
----
<1> The documentation for https://docs.python.org/3.6/library/functions.html#print[`print`] is a little complicated.footnote:[https://docs.python.org/3.6/library/functions.html#print]
