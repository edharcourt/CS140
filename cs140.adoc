...
<4> Keep redrawing a red line in the middle to represent 0 chips.

The Gamler's Ruin is one example of a _random walk_. Random walks are used for builing models in many disciplines including economics and physics. In economics random walks are often to model fluxuations in random processes sch as the stock market. In physics, a random walk can model random motion such as _Brownian motion_. 
