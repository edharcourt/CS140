...
There are stem:[94] one character passwords, stem:[94^2 = 8836] two character passwords, stem:[94^3 = 830584] three chaacter passwords, and so on so that if a password was ten characters long there are stem:[94^10 = 53861511409489970176] possible passwords. 
