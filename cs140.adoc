...
Up until know all of the input to our programs has been coming from the command line (or by pygame events). It is common though that data come from a separate text file. For example, a text file of numbers, or strings.
